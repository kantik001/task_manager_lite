        ...
        <div class="w-full flex items-center">
            <div>
                ...
                <div class="flex">
                    ...
                    <div >
                        {{Form::select('filter[created_by_id]', $users, $filter['created_by_id'] ?? null, ['placeholder' => __('layout.table_creator'), 'class' => 'form-select ml-2 rounded border-gray-300'])}}                        </div>
                    <div>
