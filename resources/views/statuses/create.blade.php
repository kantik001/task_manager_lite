...
@section('content')
    ...
    @auth()
        <div class="grid col-span-full">
            <h1 class="max-w-2xl mb-4 text-4xl leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">{{ __('layout.statuses_create') }}</h1>

            {{ Form::open(['url' => route('statuses.store'), 'method' => 'POST', 'class' => 'w-50']) }}
